...
FROM [dbo].[ApprovedMeterInstallation]
GROUP BY 
    [Installer_ID],
    [Mapped_Contractor_ID],
    [New_Meter_Phase],
...
GROUP BY 
    ...
    END
ORDER BY 
    [Mapped_Contractor_ID], [Installer_ID];
...
ORDER BY [Mapped_Contractor_ID], [Installer_ID];
...
WHERE 
    ...
    COUNT(*) AS TotalMeters
FROM [dbo].[ApprovedMeterInstallation] a
JOIN [dbo].[ApprovedMeterInstallation] b
